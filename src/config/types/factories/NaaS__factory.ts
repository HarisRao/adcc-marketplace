...
const _abi = [
          ...
          },
          {
            components: [
              ...
              },
              {
                ...
                internalType: "struct LibERC1155Lazy.Token[]",
                name: "tokens",
                type: "tuple[]",
              },
            ],
            internalType: "struct LibERC1155Lazy.Collection[]",
            name: "collections",
            type: "tuple[]",
          },
          {
  ...
  {
    inputs: [],
    name: "proxyRegistryAddressApply",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    inputs: [],
    name: "proxyRegistryAddressPending",
    outputs: [
      {
        internalType: "address",
        name: "",
  ...
  {
    inputs: [],
    name: "proxyRegistryAddressPendingTime",
    outputs: [
      {
        internalType: "uint256",
        name: "",
  ...
  {
    inputs: [],
    name: "proxyRegistryAddressRevoke",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
