...
const MarketplacesliderCard:React.FC=()=>{
    return(
        <div className='mx-2 hall-div'>
            <div className="card bg-transparent" style={{border:'none'}}>
                ...
                <div className="card-body pr-1 pl-0 pl-sm-0 pt-3 pb-4" style={{position:'relative'}}>
                  <p className='text-white pr-1 h2 pl-1 pl-sm-0 text-sm-right mb-1'>KYRA GRACIE</p>
                    ...
                    <div style={{position:'absolute',top:'1px'}}>
                        <img className="card-img-top hall-of-fame-invert-card-img"  style={{borderRadius:'10px'}} src={hallcardimg} alt="..."/>
                    </div>
                </div>
            </div>
...
export default MarketplacesliderCard